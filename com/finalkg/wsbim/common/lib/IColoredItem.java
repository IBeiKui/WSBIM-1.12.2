...
public interface IColoredItem{
	...
	public abstract int getItemColor(ItemStack colorStack);
	/**Sets the color for the chest itemstack*/
	public abstract void setItemColor(ItemStack colorStack, int color);
	/**Remove the color for the chest itemstack*/
	public abstract void removeItemColor(ItemStack colorStack);
	/**Returns true if the colored itemstack has a color. Use NBT parsing for all of these methods. See ItemArmor for examples.*/
	public abstract boolean hasItemColor(ItemStack colorStack);
}
